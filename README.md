...
| 步骤 | 内容 | 操作 |
| -------- | ------- | ------- |
| 01 | 认识 GitHub Copilot 模型的各种能力  | 进入  |
| 02 | 了解 GitHub Copilot Edit 模式下使用 Agent 模式    | 进入  |
| 03 | 在 Ageent 模式下创建 Copilot 应用前端   | 进入  |
| 04 | 通过 GitHub Copilot Agent 调用 GitHub Models  | 进入  |
| 05 | 通过 GitHub Copilot Agent 把应用部署在容器中  | 进入  |
